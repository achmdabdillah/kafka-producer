...
public class TopicProducer {
    ...
    @Value("${topic.name.screening_satu}")
    private String screening_satu;

    @Value("${topic.name.confirm_docver}")
    private String confirm_docver;
    ...
    @Value("${topic.name.overtime_process}")
    private String overtime_process;
    ...
    @Value("${topic.name.entry_manual_screening_dua}")
    private String entrymanual2;

    @Value("${topic.name.cancel_todolist}")
    ...
    @Value("${topic.name.result_pre_ppd}")
    private String result_pre_ppd;

    @Value("${topic.name.result_ppd_livin}")
    private String result_ppd_livin;
    ...
    public void send_result_ppd_livin(String message) {
        kafkaTemplate.send(result_ppd_livin, message);
    }
    ...
    public void send_screening_satu(String message) {
        kafkaTemplate.send(screening_satu, message);
    }
    ...
    public void send_result_pre_ppd(String message) {
        kafkaTemplate.send(result_pre_ppd, message);
    }
    ...
    public void send_overtime_process(String message) {
        kafkaTemplate.send(overtime_process, message);
    }
    ...
    public void send_confirm_docver(String message) {
        kafkaTemplate.send(confirm_docver, message);
    }

    public void send_entrymanual2(String message) {
        kafkaTemplate.send(entrymanual2, message);
    }

    public void send_cancel_todolist(String message) {
        kafkaTemplate.send(cancel_todolist, message);
    }
